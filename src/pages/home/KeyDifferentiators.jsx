...
const KeyDifferentiators = () => {
  return (
    <section className="bg-white py-16 lg:px-24">
      <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">¿Por qué elegir mis servicios?</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <DifferentiatorCard
          icon={<FaAward size={60} className="text-white mb-4" />}
          title="Experiencia Probada"
          description="Más de 15 años de experiencia en la práctica médica y en procedimientos avanzados."
        />
        <DifferentiatorCard
          icon={<FaMicroscope size={60} className="text-white mb-4" />}
          title="Tecnología Avanzada"
          description="Uso de equipo médico de última generación para garantizar diagnósticos precisos."
        />
        <DifferentiatorCard
          icon={<FaUserShield size={60} className="text-white  mb-4" />}
