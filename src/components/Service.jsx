...
const ServiceCard = ({ title, description, image }) => {
  return (
    <div className="group mt-1 cursor-pointer relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
